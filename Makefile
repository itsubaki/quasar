...
deploy:
	...
	gcloud run deploy --region ${LOCATION} --project ${PROJECT_ID} --image ${IMAGE} --set-env-vars=PROJECT_ID=${PROJECT_ID},DATABASE_ID=${DATABASE_ID},USE_CPROF=true,MAX_QUBITS=12 ${SERVICE_NAME}
